...
import { useOptionalAgentTraceSelection } from "./traces/AgentTraceSidebar"
...
export function GroupAvatar({
  ...
  const traces = useOptionalAgentTraceSelection()
