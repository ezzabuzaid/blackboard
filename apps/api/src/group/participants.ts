...
import type { createChatGPTSubscription } from "../chatgpt.js"
import type { WhatsAppParticipant } from "./whatsapp.js"

type ChatGPTSubscription = Awaited<ReturnType<typeof createChatGPTSubscription>>

export function createWhatsAppParticipants(
  dataDirectory: string,
  chatgpt: ChatGPTSubscription
) {
